# Generated by Django 3.2.4 on 2021-12-01 16:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ordercode', models.IntegerField(auto_created=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Regent.order')),
                ('products', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Regent.meal')),
            ],
        ),
        migrations.AddField(
            model_name='order',
